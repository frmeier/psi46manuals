...
\begin{itemize}
    ...
    \item A custom, programmable digital level translator chip (LCDS--LVDS), which is identical to the one used in the full readout chain and capable of handling all levels needed for proper communication iwth ROC and TBM.
    \item A jumper-programmable level converter to common signal levels like CMOS and NIM for external clock and triggering plus read-back of DTB internal didgital signals.
