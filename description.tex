...
\begin{figure}[hbtp]
	...
	\label{fig:DTBphoto}
	\caption{Photograph of front and back panel.}
    \end{center}
\end{figure}

\section{ROC/Module Test Adaptor}

This connector is used to connect a single \gls{ROC} or a module. It has 68~pins and uses standard SCSI connectors. The connection has been succesfully tested to support ribbon cables of up to 1~m length.
